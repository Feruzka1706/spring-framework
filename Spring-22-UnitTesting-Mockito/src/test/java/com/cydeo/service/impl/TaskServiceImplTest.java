...
class TaskServiceImplTest {
    ...
    @InjectMocks //it will inject above mocks and also will create bean object for taskserviceImpl to use for testing
    ...
    void findById_test(long id){
        ...
        //OR when(taskMapper.convertToDTO(task)).thenReturn(new TaskDTO());
