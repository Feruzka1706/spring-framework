...
@RestController
@RequestMapping("/courses/api/v3") //creating versioning of API end points
public class CourseController_ResponseWrapper {
    ...
    public ResponseEntity<ResponseWrapper> getCourseById(@PathVariable("id") Long courseId){
        ...
        return ResponseEntity.ok(new ResponseWrapper("course: " + courseId +
                " retrieved ",courseService.getCourseById(courseId)));
    }
