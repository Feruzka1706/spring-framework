...
public class Consume_WebClient {
   ...
   @GetMapping("/mono-movie-cinema/{id}")
    public Mono<MovieCinema> readMovieBydId(@PathVariable("id") Long id){
    ...
    */
    ...
    @GetMapping("/mono-movie-cinema/{id}")
    public ResponseEntity<Mono<MovieCinema>> readMovieBydId(@PathVariable("id") Long id){
    ...
    public Mono<Void> deleteGenre(@PathVariable("id") Long id){
        ...
        return Mono.empty(); //we are not returning any body, just empty response
    }
